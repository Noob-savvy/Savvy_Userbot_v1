...
from data import OneWord, RAID, SAVVY
...
async def dmraid(xspam: Client, message: Message):
      ...
      if len(alt) == 3:
          ...
          if id in SAVVY:
                await message.reply_text(f"`ᴠᴇʀɪғɪᴇᴅ ʙʏ ✨𝐍𝐎𝐎𝐁_𝐒𝐀𝐕𝐕𝐘✨`")
...
async def dmspam(client: Client, message: Message):
    ...
    if  len(alt) == 4:
        ...
        await message.reply_text("😈 ᴜsᴀɢᴇ:\n .dmspam 13 <ᴜꜱᴇʀ ɪᴅ> Noob savvy\n .dmspam 13 Noob savvy <ʀᴇᴘʟʏ ᴛᴏ ᴜsᴇʀ>")
